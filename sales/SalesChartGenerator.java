/*
 * Concrete chart generator for sales reports
 */
...
/**
 * Concrete implementation of ChartGenerator for sales reports
 */
public class SalesChartGenerator implements ChartGenerator {
    ...
    public void generateCharts(Date fechaInicio, Date fechaFin) throws IOException, SQLException {
        generateVentasPorProductoChart(fechaInicio, fechaFin, "ventas_por_producto.png");
        generateVentasPorEmpleadoChart(fechaInicio, fechaFin, "ventas_por_empleado.png");
        generateProductosMenosVendidosChart(fechaInicio, fechaFin, "productos_menos_vendidos.png");
    }

    private String generateVentasPorProductoChart(Date fechaInicio, Date fechaFin, String rutaArchivo) throws IOException, SQLException {
    ...
    private String generateVentasPorEmpleadoChart(Date fechaInicio, Date fechaFin, String rutaArchivo) throws IOException, SQLException {
    ...
    private String generateProductosMenosVendidosChart(Date fechaInicio, Date fechaFin, String rutaArchivo) throws IOException, SQLException {
