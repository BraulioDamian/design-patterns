 ...
 * @author Luis
 */
public class AvisosFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        jLabel2 = new JLabel();
        btnCrearGrafica = new JButton();
        txtFechaFinal = new JTextField();
        txtFechaInicio = new JTextField();
        jLabel3 = new JLabel();
        jLabel4 = new JLabel();
        MenuPlegable2 = new JPanel();
        Menu2 = new JLabel();
        Inicio2 = new JLabel();
        Usuarios2 = new JLabel();
        Configuracion2 = new JLabel();
        Ventas2 = new JLabel();
        Analisis2 = new JLabel();
        Inventario2 = new JLabel();

        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pocas.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        prox.setModel(new DefaultTableModel(
            new Object [][] {
                ...
                .addGroup(Panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(Panel2Layout.createSequentialGroup()
                        .addGroup(Panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 650, GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(Panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(Panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(Panel2Layout.createSequentialGroup()
                                .addComponent(jLabel3, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
                                .addGap(33, 33, 33)
                                .addComponent(jLabel4, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE))
                            .addGroup(Panel2Layout.createSequentialGroup()
                                .addComponent(txtFechaInicio, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
                                .addGap(33, 33, 33)
                                .addComponent(txtFechaFinal, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        Menu2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Inicio2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Usuarios2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Configuracion2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Ventas2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Analisis2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
        ...
        Inventario2.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 10));
...
//            });
    ...
    private JLabel Analisis2;
    private JLabel Configuracion2;
    private JLabel Inicio2;
    private JLabel Inventario2;
    private JLabel Menu2;
    private JPanel MenuPlegable2;
    private JPanel Panel2;
    private JLabel Usuarios2;
    private JLabel Ventas2;
    private JButton btnCrearGrafica;
