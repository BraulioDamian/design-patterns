 ...
 * @author braul
 */
public class UsuariosPanel extends JFrame {
    ...
    public static void resetInstance() {
        ...
        if (usuarioLogueado.getRol() == Rol.EMPLEADO) {
...
private void ajustarTamanioColumnasYFilas() {
    ...
    private void initComponents() {
        ...
        MenuPlegable2.setBackground(new Color(204, 204, 204));
        MenuPlegable2.setLayout(null);

        Menu2.setHorizontalAlignment(SwingConstants.RIGHT);
        Menu2.setIcon(new ImageIcon(getClass().getResource("/Icons/Menu32px.png"))); // NOI18N
        ...
        Inicio2.setHorizontalAlignment(SwingConstants.RIGHT);
        Inicio2.setIcon(new ImageIcon(getClass().getResource("/Icons/Inicio32px.png"))); // NOI18N
        ...
        Inicio2.setHorizontalTextPosition(SwingConstants.LEADING);
        ...
        Usuarios2.setForeground(new Color(255, 255, 255));
        Usuarios2.setHorizontalAlignment(SwingConstants.RIGHT);
        Usuarios2.setIcon(new ImageIcon(getClass().getResource("/Icons/Usuarios32px.png"))); // NOI18N
        ...
        Usuarios2.setHorizontalTextPosition(SwingConstants.LEADING);
        Usuarios2.setIconTextGap(15);
        Usuarios2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        Configuracion2.setForeground(new Color(255, 255, 255));
        Configuracion2.setHorizontalAlignment(SwingConstants.RIGHT);
        Configuracion2.setIcon(new ImageIcon(getClass().getResource("/Icons/Configuraciones32px.png"))); // NOI18N
        ...
        Configuracion2.setHorizontalTextPosition(SwingConstants.LEADING);
        Configuracion2.setIconTextGap(15);
        Configuracion2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        Ventas2.setForeground(new Color(255, 255, 255));
        Ventas2.setHorizontalAlignment(SwingConstants.RIGHT);
        Ventas2.setIcon(new ImageIcon(getClass().getResource("/Icons/Venta32px.png"))); // NOI18N
        ...
        Ventas2.setHorizontalTextPosition(SwingConstants.LEADING);
        Ventas2.setIconTextGap(15);
        Ventas2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        Analisis2.setForeground(new Color(255, 255, 255));
        Analisis2.setHorizontalAlignment(SwingConstants.RIGHT);
        Analisis2.setIcon(new ImageIcon(getClass().getResource("/Icons/Graficas32px.png"))); // NOI18N
        ...
        Analisis2.setHorizontalTextPosition(SwingConstants.LEADING);
        Analisis2.setIconTextGap(15);
        Analisis2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        Inventario2.setForeground(new Color(255, 255, 255));
        Inventario2.setHorizontalAlignment(SwingConstants.RIGHT);
        Inventario2.setIcon(new ImageIcon(getClass().getResource("/Icons/Inventario32px.png"))); // NOI18N
        ...
        Inventario2.setHorizontalTextPosition(SwingConstants.LEADING);
        Inventario2.setIconTextGap(15);
        Inventario2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        NuevoUsuario.setBackground(new Color(190, 184, 209));
        ...
        Empleados.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void Menu2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Menu2MouseClicked
    ...
    private void Menu2MouseEntered(MouseEvent evt) {//GEN-FIRST:event_Menu2MouseEntered

    }//GEN-LAST:event_Menu2MouseEntered

    private void Menu2MouseExited(MouseEvent evt) {//GEN-FIRST:event_Menu2MouseExited

    }//GEN-LAST:event_Menu2MouseExited

    private void Inicio2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Inicio2MouseClicked
    ...
    private void Usuarios2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Usuarios2MouseClicked

    }//GEN-LAST:event_Usuarios2MouseClicked

    private void Configuracion2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Configuracion2MouseClicked
    ...
    private void Ventas2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Ventas2MouseClicked
    ...
    private void Analisis2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Analisis2MouseClicked
    ...
    private void Inventario2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Inventario2MouseClicked
    ...
    private void Panel2MouseClicked(MouseEvent evt) {//GEN-FIRST:event_Panel2MouseClicked
